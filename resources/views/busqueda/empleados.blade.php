...
@section('content')
    ...
    <!-- Buscador Empleo -->
    <main>
        <section id="banner_empleado">
            <div class="inner">
                <h2 class="major special">COMENCEMOS CON LA BUSQUEDA</h2>
                <p>Elegí en lo que te especializás</p>
                    ...
                    <!-- Break -->
                        ...
                        <div class="12u$">
                            <div class="select-wrapper">
                                ...
                                <div class="12u$">
                                    <ul class="actions">
                                        <li><a href="#empleado" class="button special icon fa-search buscar evBuscar scrolly">buscar</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
