    ...
    {   
        $clases = [
            array(
                ...
                'plan_estudio' => 'Las clases de piano se sostienen en estas tres columnas de conocimiento:
                    <br>1- Lectura e interpretación de partituras. ( Método para lectura de partituras )
                    <br>2- Técnica: Conciencia corporal para el mejor rendimiento en la interpretación.
                    <br>3- Armonía clásica y popular, teoría musical, composición e improvisación. (Compresión del Sistema de cifrado. Disposición - Voicings)',
                'contenidos_teoricos' => '-Comprensión y práctica de acordes
                    <br>-Escalas para la improvisación, herramientas melódicas.
                    <br>-Desarrollo del oído armónico
                    <br>-Compresión del Sistema de cifrado. Disposición (voicings)
                    <br>-Relación melodía-armonía en cualquier composición o transcripción de un solo de jazz. Así, iremos adquiriendo "criterio musical" para poder aplicar los conceptos extraídos en nuestras propias improvisaciones o composiciones. La idea no es simplemente copiar sino, imitar-asimilar-comprender y evolucionar.
                    <br>-Las escalas antiguas
                    <br>-Escala disminuida simétrica. Los arpegios.
                    <br>-Distintos roles que permite el instrumento (haciendo acompañamiento rítmico y/o armónico, como voz líder, haciendo la melodía o una contramelodía)',
            ),
            ...
            array(
                ...
                'plan_estudio' => 'Cada persona es un instrumento único e irrepetible, por esto es que en la clase combinamos diversas técnicas y trabajamos con la voz cantada y la voz hablada teniendo en cuenta criterios foniátricos.
                <br>
                <br>- Respiración diafragmática
                <br>- Apoyo del aire (Técnica lírica)
                <br>- Conciencia corporal y la importancia de la relajación (Técnica Ravine)
                <br>- Desarrollo del oído musical
                <br>- Recursos expresivos propios de cada estilo musical
                ',
                'contenidos_teoricos' => 'Durante la primera parte de la clase se realizan ejercicios para la respiración, relajación  y concientización del cuerpo. Se trabaja sobre el registro del alumno por medio de las vocalizaciones sobre diferentes escalas, arpegios, secuencias armónicas para perfeccionar la afinación. Estos ejercicios permiten ir ampliando el registro tanto en graves como agudos. En la segunda parte de la clase se trabaja con el repertorio propuesto por el alumno. Buscando una paulatina sensibilización por distintos estilos musicales, un incremento de la capacidad expresiva del alumno y una búsqueda de recursos expresivos.',
            ),
            ...
            array(
                ...
                'objetivos' => 'Lograr que el alumno lea y escriba música; y pueda interpretarla. Desarrollar su creatividad y un estilo propio. Lograr que el alumno se pueda desenvolver tocando en grupo, adaptándose y aportando su identidad musical propia.',
                'plan_estudio' => ' - Comprensión y práctica de acordes
                                    <br>- Lectura de tablaturas (Solos y Riffs)
                                    <br>- Escalas para la improvisación, herramientas melódicas.
                                    <br>- Desarrollo del oído armónico
                                    <br>- Compresión del Sistema de cifrado. Disposición (voicings)
                                    <br>- Relación melodía-armonía
                                    <br>- Distintos roles que permite el instrumento (haciendo acompañamiento rítmico y/o armónico, como voz líder, haciendo la melodía o una contramelodía)
                                    <br>- Exploración de estilos musicales (rock, pop, funk, soul, blues, jazz, etc).',
                'contenidos_teoricos' => '',
            ),
            ...
            array(
                ...
                'objetivos' => 'Lograr que el alumno lea y escriba música; y pueda interpretarla. Desarrollar su creatividad y un estilo propio. Lograr que el alumno se pueda desenvolver tocando en grupo, adaptándose y aportando su identidad musical propia. ',
                'plan_estudio' => ' - Técnicas de ejecución (Dedos, Slapping-popping, Acordes, Armónicos), escalas, armado de bases.
                                    <br>- Escalas, arpegios e inversiones.
                                    <br>- Solos y líneas sobre cadencias tonales y sobre modal en distintos niveles.
                                    <br>- Interpretación de piezas musicales. Composición e improvisación.
                                    <br>- Exploración de estilos musicales (rock, pop, funk, soul, blues, jazz, etc). 
                                    <br>- Ejercicios de Lectura a primera vista. 
',
                'contenidos_teoricos' => 'Los contenidos de las clases prácticas se complementan con material de teoría musical, solfeo y armonía, para poder profundizar el aprendizaje y el conocimiento del bajo y facilitar la comprensión y el abordaje de partituras y arreglos musicales.',
            ),
            ...
            array(
                ...
                'objetivos' => 'Lograr que el alumno lea y escriba música; y pueda interpretarla. Desarrollar su creatividad y un estilo propio. Lograr que el alumno se pueda desenvolver tocando en grupo, adaptándose y aportando su identidad musical propia. ',
                'plan_estudio' => ' -Técnicas de ejecución, escalas, armado de bases.
                                    -Escalas, arpegios e inversiones,
                                    -Solos y líneas sobre cadencias tonales y sobre modal en distintos niveles.
                                    -Interpretación de piezas musicales. Composición e improvisación.
            ...
            array(
                ...
                'objetivos' => 'Lograr que el alumno lea y escriba música; y pueda interpretarla. Desarrollar su creatividad y un estilo propio. Lograr que el alumno se pueda desenvolver tocando en grupo, adaptándose y aportando su identidad musical propia.',
                'plan_estudio' => ' - Técnicas de ejecución 
                                    <br>- Lectura de partituras
                                    <br>- Escalas y arpegios.
                                    <br>- Repertorio  e improvisación.
                                    <br>- Exploración de estilos musicales 
                                    <br>- Ejercicios de Lectura a primera vista. 
                                    ',
                'contenidos_teoricos' => '',
            ),
            ...
            array(
                ...
                'objetivos' => 'Lograr que el alumno lea y escriba música; y pueda interpretarla. Desarrollar su creatividad y un estilo propio. Lograr que el alumno se pueda desenvolver tocando en grupo, adaptándose y aportando su identidad musical propia.',
                'plan_estudio' => ' - Técnicas de ejecución: posición corporal, la respiración, distintas sonoridades mediante el uso de las manos, lengua.
                                    <br>- Articulación del sonido
                                    <br>- Repertorio, composición e improvisación.
                                    <br>- Distintos roles que permite el instrumento (haciendo acompañamiento rítmico y/o armónico, como voz líder, haciendo la melodía o una contramelodía)
                                    <br>- Exploración de estilos musicales 
                                    <br>- Ejercicios de Lectura a primera vista.',
                'contenidos_teoricos' => '',
            ...
            array(
                ...
                'plan_estudio' => ' - Técnicas de ejecución
                                    <br>- Rudimentos
                                    <br>- Las distintas claves
                                    <br>- Interpretación de piezas musicales.
                                    <br>- Improvisación.
                                    <br>- Exploración de estilos musicales 
                                    <br>- Ejercicios de Lectura a primera vista.',
                'contenidos_teoricos' => '',
            ...
            array(
                ...
                'plan_estudio' => ' - Comprensión y práctica de acordes
                                    <br>- Escalas para la improvisación, herramientas melódicas.
                                    <br>- Desarrollo del oído armónico
                                    <br>- Compresión del Sistema de cifrado. 
                                    <br>- Relación melodía-armonía
                                    <br>- Exploración de estilos musicales',
                'contenidos_teoricos' => '',
            ),
            ...
            array(
                ...
                'objetivos' => 'Lograr que el alumno lea y escriba música; y pueda interpretarla. Desarrollar su creatividad y un estilo propio. Lograr que el alumno se pueda desenvolver tocando en grupo, adaptándose y aportando su identidad musical propia. ',
                'plan_estudio' => ' - Lectura de partituras
                                    <br>- Técnicas de ejecución
                                    <br>- La embocadura 
                                    <br>- Emisión del sonido
                                    <br>- Repertorio, composición e improvisación.
                                    <br>- Distintos roles que permite el instrumento (haciendo acompañamiento rítmico y/o armónico, como voz líder, haciendo la melodía o una contramelodía)
                                    <br>- Exploración de estilos musicales 
                                    <br>- Ejercicios de Lectura a primera vista.',
            ...
            array(
                ...
                'plan_estudio' => ' - Comprensión y práctica de acordes
                                    ...
                                    <br>- Escalas para la improvisación, herramientas melódicas.
                                    <br>- Desarrollo del oído armónico
                                    <br>- Compresión del Sistema de cifrado.-Relación melodía-armonía
                                    <br>- Exploración de estilos musicales',
                'contenidos_teoricos' => '',
            ),
            ...
            array(
                ...
                'objetivos' => 'Introducir al alumno en el lenguaje musical
                                <br>Explorar los distintos instrumentos e identificar qué instrumento es el que más le interesa
                                <br>Técnica para tocar cada instrumento
                                <br>Desarrollar la creatividad del alumno
                                <br>Desarrollar el oído musical del alumno',
                'plan_estudio' => '',
                'contenidos_teoricos' => '',
            )
        ...
        foreach($clases as $clase):
            ...
            DB::table('clases')->insert([
                ...
                'plan_estudio' => $clase['plan_estudio'],
                'contenidos_teoricos' => $clase['contenidos_teoricos']
            ]);
