...
function youtubeEmbedUrl($url) {
    ...
    return 'https://www.youtube.com/embed/'.$segments[count($segments)-1];
}
...
function checkSlug($sSlug) { if(ereg ("^[a-zA-Z0-9]+[a-zA-Z0-9_-]*$", $sSlug)) { return true; }

  return false;
}

function removeDuplicates($sSearch, $sReplace, $sSubject) { $i=0; do{
